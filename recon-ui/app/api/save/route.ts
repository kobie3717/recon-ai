export async function POST(request: Request) {
  ...
  const allowedOrigins = (process.env.ALLOWED_ORIGINS || 'https://ui-beta-green.vercel.app,https://recon.whatshubb.co.za,http://localhost:3000,http://localhost:3001,http://localhost:3002').split(',');
