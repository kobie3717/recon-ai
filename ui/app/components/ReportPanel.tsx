...
export default function ReportPanel({ report, running, cost }: ReportPanelProps) {
  const showPlaceholder = !running && !report;
  const showLoading = running && !report;
        ...
        <div className="bg-recon-navy/50 px-6 py-3 border-t border-recon-blue/30">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-4">
              <span className="text-recon-grey">Cost: <span className="text-recon-green font-semibold">${cost.toFixed(2)}</span></span>
