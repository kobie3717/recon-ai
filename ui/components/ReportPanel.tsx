      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
        ...
        {showLoading && (
          <div className="space-y-4 animate-pulse">
            <div className="h-16 bg-recon-navy/50 rounded"></div>
            <div className="grid grid-cols-2 gap-4">
              <div className="h-40 bg-recon-navy/50 rounded"></div>
              <div className="h-40 bg-recon-navy/50 rounded"></div>
            </div>
            <div className="h-64 bg-recon-navy/50 rounded"></div>
            <div className="h-48 bg-recon-navy/50 rounded"></div>
            <div className="text-center text-recon-cyan text-lg font-medium mt-8">
